...
- **Personnalisation sans code** : couleurs (primaire, secondaire, accent), polices (21 Google Fonts), logo, favicon (7 tailles auto-generees depuis le logo + PWA manifest + Windows tiles)
