 ...
 */
final class Version20260317133623 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD bio LONGTEXT DEFAULT NULL, ADD avatar_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP bio, DROP avatar_id');
    }
}
